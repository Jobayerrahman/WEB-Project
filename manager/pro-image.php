...
if($readproimage==null){
    echo '<a href="pr-image.php">Upload Image</a>';
}else{
echo
...
if(isset($_POST["submit"])){
	...
	else
	{
        ...
        $imagetmp="../images";
        move_uploaded_file($_FILES["pimage"]["tmp_name"], "$imagetmp".$_FILES["pimage"]["name"]);

		
		$str="UPDATE restaurant SET pro_pic='$image',pro_pic_name='$imagetmp' WHERE username='$username';";
