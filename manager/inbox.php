            ...
            <div class="middle_content">
                ...
                <?php
                    ...
                    else
                    {
                        ...
                        $sql="select * from chat where message_to='".$name."';";
                        ...
                        $sql="SELECT * FROM chat where message_to='".$name."' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page ;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            echo '
                            <div>
                                <p>'.$message_from.' : '.$message.'</p> 
                                
                                <a href="inbox.php?reply='.$message_from.'">Reply</a>
                ...
                <div class="middle_bottom">
                   ...
                   ?>
                   <input type="text" name="to" id="to" value="<?php echo $reply_user_id?>">
                   </p> 
                   <hr>
                   <p>Message:
                   </p>
                   <textarea name="reply" id="reply" cols="60" rows="2"></textarea>
                    <hr>
                    
                    <input type="submit" value="Reply" name="submit" class="button3">
...
$con=mysqli_connect("localhost","root","","food");
    ...
    else
    {
       if(isset($_POST["submit"])){
        ...
        $message_text=$_POST["reply"];
        $replay_id=$_POST["to"];

        $str="INSERT INTO chat (message_from,message_to,messege,timestamp) VALUES ('$message_to','$replay_id','$message_text',UNIX_TIMESTAMP()) ;";
