                        ...
                        <h4>SUBSCRIBER: <a href=""><?php echo $sub_count ?></a>
                            ...
                            <div class="middle_bottom">
                                <div id="info_right">
                                    ...
                                    <h4>Upload Cover Picture:
                                    <input type="file" name="cimage" id="image">
                                     </h4>
                                    <hr>
...
if(isset($_POST["submit"])){
	...
	else
	{
        ...
        $image2=$_FILES["cimage"]["name"]; 
        $imagetmp2="../images";
        move_uploaded_file($_FILES["cimage"]["tmp_name"], "$imagetmp2".$_FILES["cimage"]["name"]);
		
		$str="UPDATE restaurant SET cv_pic='$image2',cv_pic_name='$imagetmp2' WHERE username='$username';";
