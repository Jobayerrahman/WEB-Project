            ...
            <div class="middle_content">
                ...
                <div class="middle_bottom">
                    ...
                    else
                    {
                        ...
                        $sql="select * from offertable where restaurantname='".$name."';";
                        $result = mysqli_query($con, $sql);
                        ...
                        $sql="SELECT * FROM offertable where restaurantname='".$name."' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            echo 
                            '<img src="'.$readimage.'" width=100 height=100><br><br>
                            <div class="media-body">

                            <h4 class="media-heading">Offer Price: '.$offername.'</h4>
                            
                            <p>Food Type: '.$foodtype.'</p>
                            <p>Offer Type: '.$type.'</p>
                            <p>Duration: '.$duration.' Days</p>
                            <p>Reserve: '.$reserve.'</p>
                            <p>Offer For: '.$offerfor.'</p>
                            <p>Description: '.$description.'</p>
                            <p>Average Rating: '.$average_rate.'★</p>
                            <a href="my_posts.php?id='.$offerid.'" class="confirmation">Delete Offer</a>
                        ...
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="my_posts.php?page=' . $page . '">' . $page . '</a> ';
...
$con=mysqli_connect("localhost","root","","food");
    ...
    else
    {
        if(isset($_GET["id"])){
            $delete_id = $_GET["id"];
            $str="DELETE FROM offertable WHERE offerid='$delete_id' ;";
