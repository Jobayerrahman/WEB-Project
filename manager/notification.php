            ...
            <div class="middle_content">
                ...
                <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT userpage.username,sub.username,sub.restaurantname from userpage,sub where sub.restaurantname='$name' and userpage.username=sub.username;";
                        ...
                        $sql="SELECT userpage.username,sub.username,sub.restaurantname from userpage,sub where sub.restaurantname='$name' and userpage.username=sub.username ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page ;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            echo '
                            <div>
                               <h4 class="p-style">'.$user_name.' subscribed to your restaurant</h4>
                        ...
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="notification.php?page=' . $page . '">' . $page . '</a> ';
            ...
            <p>Subscribers Birthdays Today:</p>
                <?php
                    ...
                    else
                    {
                        ...
                        $this_page_first_result = ($page-1)*$results_per_page;
                        // retrieve selected results from database and display them on page
                        $sql="SELECT userpage.username,sub.username,sub.restaurantname from userpage,sub where sub.restaurantname='$name' and userpage.username=sub.username LIMIT " . $this_page_first_result . ',' .  $results_per_page;
