...
<body>
    ...
    <header>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="../images/burger_king.jpg" alt="Burger King" style="width:800px;">
                        </div>

                        <div class="item">
                            <img src="../images/food_republic.jpg" alt="Food Republic" style="width:800px;">
                        </div>

                        <div class="item">
                            <img src="../images/pizza_hut.jpg" alt="Pizza Hut" style="width:800px;">
                        </div>
                    </div>
        ...
        <div id="main_body">
            <h2 class="h2_style">Location:</h2>
            <p>Offers that are specific to a region or area, can be easily found by their specified locations. Here are the
            ...
            <div >
                <ul>
                    <li><h2><a href="http://localhost/project/without_login/location_based_offer.php">All Over Dhaka</a></h2></li>
                    <ul>
                        <li><h4><a href="http://localhost/project/without_login/location_based_offer.php">Uttara</a></h4></li>
                        <li><h4><a href="http://localhost/project/without_login/location_based_offer.php">Banani</a></h4></li>
                        <li><h4><a href="http://localhost/project/without_login/location_based_offer.php">Mirpur</a></h4></li>
                    </ul>
                </ul>
            </div>
        </div>
    ...
    <div id="footer">
        <div class="w3-container w3-indigo">
            ...
            <p>
                <a href="http://localhost/project/without_login/contact_us.php" class="footer_link">Connect Us</a>
                <a href="http://localhost/project/without_login/about_us.php" class="footer_link">About Us</a>
            </p>
        </div>
    </div>
    </div>
