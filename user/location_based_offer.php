...
<form action="<?php echo $_SERVER["PHP_SELF"];  ?>" method="post" enctype="multipart/form-data">
    <div id="wrapper">
        ...
        <div id="main_body">
            ...
            <div>
                <h2 class="h2_style">Offers At <?php echo $location_base;?></h2>
            </div>
            <?php
                    $con=mysqli_connect("localhost","root","","food");
                    ...
                    else
                    {
                        ...
                        $sql="SELECT offertable.*,restaurant.area,restaurant.name from offertable,restaurant where offertable.restaurantname=restaurant.name and restaurant.area='$location_base' and offertable.offerfor='everyone';";
                        ...
                        $sql="SELECT offertable.*,restaurant.area,restaurant.name from offertable,restaurant where offertable.restaurantname=restaurant.name and restaurant.area='$location_base' and offertable.offerfor='everyone' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            <a href="location_based_offer.php?sub='.$restaurantname.'"><h2>'.$restaurantname.' 
                            <a href="location_based_offer.php?sub='.$restaurantname.'" class="sub-button">SUBSCRIBE</a></h2> </a>
                            ...
                            for ($x = 1; $x <= 5; $x++) {
                                ?>
                                <a href="location_based_offer.php?area=<?php echo $location_base;?>&item=<?php echo $offerid; ?>&rating=<?php echo $x; ?>"><?php echo $x; ?></a>
                                <?php
                            } // end-of FOR
                            ...
                            <div>
                            <a href="location_based_offer.php?area='.$location_base.'&offer='.$offerid.'" class="btn">Bookmark Offer</a>
                            </div>
                            </div>';
            ...
            // display the links to the pages
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="location_based_offer.php?page=' . $page . '" class="pagi">' . $page . '</a> ';
