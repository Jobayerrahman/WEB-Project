...
<form action="<?php echo $_SERVER["PHP_SELF"];  ?>" method="post" enctype="multipart/form-data">
    <div id="wrapper">
        ...
        <div id="main_body">
            ...
            <div>
                <h2 class="h2_style">Pizza Offers: </h2>
            </div>
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT * from offertable WHERE food_type='pizza' and offerfor='everyone';";
                        ...
                        $sql="SELECT * from offertable WHERE food_type='pizza' and offerfor='everyone' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            <a href="category_pizza.php?sub='.$restaurantname.'"><h2>'.$restaurantname.' 
                            <a href="category_pizza.php?sub='.$restaurantname.'" class="sub-button">SUBSCRIBE</a></h2> </a>
                            ...
                            for ($x = 1; $x <= 5; $x++) {
                                ?>
                                <a href="category_pizza.php?item=<?php echo $offerid; ?>&rating=<?php echo $x; ?>"><?php echo $x; ?></a>
                                <?php
                            } // end-of FOR
                            ...
                            <div>
                            <a href="category_pizza.php?offer='.$offerid.'" class="btn">Bookmark Offer</a>
                            </div>
                            </div>';
            ...
            // display the links to the pages
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="category_pizza.php?page=' . $page . '" class="pagi">' . $page . '</a> ';
