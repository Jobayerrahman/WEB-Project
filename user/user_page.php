        ...
        <div id="main_body">
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT * from offertable WHERE offerfor='everyone';";
                        ...
                        $sql="SELECT * FROM offertable WHERE offerfor='everyone' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            <a href="individual_restaurent.php?name='.$restaurantname.'"><h2>'.$restaurantname.' 
                            ...
                            for ($x = 1; $x <= 5; $x++) {
                                ?>
                                <a href="user_page.php?item=<?php echo $offerid; ?>&rating=<?php echo $x; ?>"><?php echo $x; ?></a>
                                <?php
                            } // end-of FOR
                            ...
                            <div>
                            <a href="user_page.php?offer='.$offerid.'" class="btn">Bookmark Offer</a>
                            </div>
                    ...
                    <div class="card3">
                        ...
                        <h3 class="card2-style">Trending Offers:</h3>
                        <hr>
                        <?php
                    $con=mysqli_connect("localhost","root","","food");
                    ...
                    else
                    {
                        ...
                        $sql="SELECT * FROM offertable ORDER BY rating_count DESC LIMIT 5 ;";
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            <h5><a href=""  class="card2-style">'.$type.'      '.$foodtype.' At '.$restaurantname.'</a></h5>
