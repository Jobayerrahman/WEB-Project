        ...
        <div id="main_body">
            <div class="w3-container">
                <div class="w3-bar w3-blue">
                    ...
                    <a href="http://localhost/project/user/nearme.php" class="w3-bar-item w3-button">Near Me</a>
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT offertable.*,userpage.username,userpage.area,restaurant.area,restaurant.name from offertable,userpage,restaurant where userpage.area=restaurant.area, offertable.restaurantname=rantaurant.name and userpage.name='$username' ;";
                        ...
                        $sql="SELECT offertable.*,userpage.username,userpage.area,restaurant.area,restaurant.name from offertable,userpage,restaurant where userpage.area=restaurant.area, offertable.restaurantname=rantaurant.name and userpage.name='$username' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           <a href="user_page.php?sub='.$restaurantname.'"><h2>'.$restaurantname.' 
                           <a href="user_page.php?sub='.$restaurantname.'" class="sub-button">SUBSCRIBE</a></h2> </a>
                           ...
                           for ($x = 1; $x <= 5; $x++) {
                               ?>
                               <a href="subscribe.php?item=<?php echo $offerid; ?>&rating=<?php echo $x; ?>"><?php echo $x; ?></a>
                               <?php
                           } // end-of FOR
                           ...
                           <div>
                           <a href="subscribe.php?offer='.$offerid.'" class="btn">Bookmark Offer</a>
                           </div>
                           </div>';
