        ...
        <div id="main_body">
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT offertable.*,sub.restaurantname,sub.username from offertable,sub WHERE sub.restaurantname=offertable.restaurantname and sub.username='$username' and offerfor='subscriber';";
                        ...
                        $sql="SELECT offertable.*,sub.restaurantname,sub.username from offertable,sub WHERE sub.restaurantname=offertable.restaurantname and sub.username='$username' and offerfor='subscriber' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           <a href="subscribe.php?sub='.$restaurantname.'"><h2>'.$restaurantname.' 
                           <a href="subscribe.php?sub='.$restaurantname.'" class="sub-button">SUBSCRIBE</a></h2> </a>
            ...
            // display the links to the pages
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="subscribe.php?page=' . $page . '" class="pagi">' . $page . '</a> ';
