...
<form action="<?php echo $_SERVER["PHP_SELF"];  ?>" method="post" enctype="multipart/form-data">
    <div id="wrapper">
        ...
        <div id="main_body">
            ...
            <div>
                <h2 class="h2_style">Buy One Get Two Free Offers: </h2>
            </div>
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT * from offertable WHERE type='buy one get two' and offerfor='everyone';";
                        ...
                        $sql="SELECT * from offertable WHERE type='buy one get two' and offerfor='everyone' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
