...
<form action="<?php echo $_SERVER["PHP_SELF"];  ?>" method="post" enctype="multipart/form-data">
    <div id="wrapper">
        ...
        <div id="main_body">
            ...
            <div>
                <h2 class="h2_style">Special Discount Offers: </h2>
            </div>
            ...
            <?php
                    ...
                    else
                    {
                        ...
                        $sql="SELECT * from offertable offertable WHERE type like '% discount' and offerfor='everyone';";
                        ...
                        $sql="SELECT * from offertable WHERE type like '% discount' and offerfor='everyone' ORDER BY `timestamp` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        ...
                        while($row = mysqli_fetch_array($result)) {
                           ...
                           // echo $offername . ' ' . '<br>';
                            ...
                            <a href="special_discount.php?sub='.$restaurantname.'"><h2>'.$restaurantname.' 
                            <a href="special_discount.php?sub='.$restaurantname.'" class="sub-button">SUBSCRIBE</a></h2> </a>
                            ...
                            for ($x = 1; $x <= 5; $x++) {
                                ?>
                                <a href="special_discount.php?item=<?php echo $offerid; ?>&rating=<?php echo $x; ?>"><?php echo $x; ?></a>
                                <?php
                            } // end-of FOR
                            ...
                            <div>
                            <a href="special_discount.php?offer='.$offerid.'" class="btn">Bookmark Offer</a>
                            </div>
                            </div>';
            ...
            // display the links to the pages
                        for ($page=1;$page<=$number_of_pages;$page++) {
                            echo '<a href="special_discount.php?page=' . $page . '" class="pagi">' . $page . '</a> ';
