            ...
            <div id="main_body">
                <div class="w3-container">
                    <div class="w3-bar w3-blue">
                        <a href="http://localhost/project/index.php" class="w3-bar-item w3-button">All Offers</a>
                        <a href="http://localhost/project/login/login.php" class="w3-bar-item w3-button">Subscribed</a>
                    </div>
                </div>

                <div class="card">
                    <a href="../without_login/offer_page.php"></a><img src="images/takeout.jpg" alt="TakeOut" class="card_img">
                    <a href="../without_login/individual_restaurent.php"><h2>TakeOut</h2></a>
            ...
            <div id="footer">
                <div class="w3-container w3-indigo">
                    ...
                    <p>
                        ...
                        <a href="http://localhost/project/about_us.php" class="footer_link_second">About Us</a>
                    </p>
                </div>
            </div>
        </div>
